import { topPlasticCategories } from '../../data/impact'
  ...
  return (
    <section className="flex h-full flex-col overflow-hidden rounded-2xl border border-slate-200/80 bg-white">
      <header className="flex items-center justify-between border-b border-slate-100 px-5 py-3">
        <div>
          <div className="text-sm font-semibold text-slate-800">Plastic mix</div>
          <div className="text-[0.72rem] text-slate-500">Top categories captured this month</div>
        </div>
