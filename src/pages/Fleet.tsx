...
import FleetHeaderSeabin from '../components/fleet/FleetHeaderSeabin';
...
export default function Fleet() {
    ...
    const counts = useMemo(
        () => ({
            ...
            critical: seabins.filter((s) => s.contamination_risk === 'critical')
                .length,
        }),
        [seabins],
    );
                ...
                <div className='relative flex items-center justify-between gap-6'>
                    <div className='min-w-0'>
                        ...
                        <p className='mt-1 max-w-xl text-sm text-slate-500'>
                            {counts.total} seabins across the Klang estuary —
                            filter, search, and jump to any unit.
                        </p>
                    ...
                    <FleetHeaderSeabin seabin={headerSeabin} />
                </div>
            </header>
                ...
                <div className='flex flex-col gap-2 border-b border-slate-100 px-4 py-3 sm:flex-row sm:items-center sm:justify-between'>
                    ...
                    <div className='text-right text-[0.72rem] text-slate-500'>
                        ...
                        <div className='mt-0.5 text-[0.68rem] text-slate-400'>
                            Heat overlay = debris intensity (warmer = heavier load).
                        </div>
                    </div>
                </div>
...
function StatPill({
    ...
    return (
        ...
        >
            <span className='text-[0.66rem] uppercase tracking-[0.14em] opacity-80'>
                {label}
            </span>
